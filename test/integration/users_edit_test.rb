...
class UsersEditTest < ActionDispatch::IntegrationTest
  ...
  # successful edit test w/ friendly forwarding flow
  # 1. get user edit page
  # 2. login as user as @gai
  # 2.5. friendly forwarding: verify the page is redirected to edit page
  ...
  test "edit user successfully with friendly forwarding" do
    get edit_user_path(@gai)
    log_in_as(@gai)

    # friendly forwarding
    assert_redirected_to edit_user_path(@gai) unless session[:forwarding_url].nil?
